...
function generateEmailHTML(result) {
  ...
  const contentMap = {
    "Fear": {
      ...
      mirror: `
      You're the one people count on. Clear. Strategic. Relentless.
...
Different parts of you are trying to protect you - each trying to keep you safe in its own way.  Until they come into alignment, they create a tug-of-war that drains your energy, limits your potential and stalls your progress.`,
      cost: `
      Here's the truth: every time you fight yourself, you lose momentum.
...
What has conditioning already cost you - and when is now a good time to claim it all back?`,
  ...
  // Helper function to format content with preserved line breaks
    ...
    <body>
        <div class="email-container">
            ...
            <div class="content-section">
                ...
                <div class="section-content">
                    <p>${formatContent(content.reveal)}</p>
                </div>
            </div>
            ...
            <div class="content-section">
                ...
                <div class="section-content">
                    <p>${formatContent(content.cost)}</p>
                </div>
            </div>
            ...
            <div class="content-section">
                ...
                <div class="section-content">
                    <p>${formatContent(content.possibility)}</p>
                </div>
            </div>
            ...
            <div class="content-section">
                ...
                <div class="section-content">
                    <p>${formatContent(content.reflection)}</p>
                </div>
            </div>
            ...
            <div class="content-section">
                ...
                <div class="section-content">
                    <p>${formatContent(description.fullDescription)}</p>
                </div>
            </div>
            ...
            <div class="content-section">
                ...
                <div class="section-content">
                    <p>${formatContent(content.solution)}</p>
                </div>
            </div>
            ...
            <div class="content-section">
                ...
                <div class="section-content">
                    <p>${formatContent(content.yourmove)}</p>
                </div>
            </div>
